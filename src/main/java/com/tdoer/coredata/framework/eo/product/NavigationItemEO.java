package com.tdoer.coredata.framework.eo.product;
...
public class NavigationItemEO {
    ...
    public Integer getContextScope() {
        return contextScope;
    }

    public void setContextScope(Integer contextScope) {
