...
(
   ...
   WEB_REDIRECT_URI     varchar(256) default NULL comment '用户认证通过后重定向URI',
   ACCESS_TOKEN_VALIDITY int comment '访问令牌有效期限，单位秒，例如：43200, 12 小时',
   REFRESH_TOKEN_VALIDITY int comment '刷新令牌的有效期限，单位秒，例如：2592000，30 天',
   SESSION_POLICY       varchar(64) comment '用户Session创建策略：KICK_OFF_PREVIOUS',
